...
export default function FormModal({ dataUser, fetchUser, onCancel }: Props) {
				...
				setFileList([
					{
						...
						name: dataUser.image,
						status: 'done',
						url: `${process.env.NEXT_PUBLIC_IMAGE_URL}/user/${dataUser.image}`
					}
				]);
			}
		} else {
			...
			>
				<Row gutter={[16, 16]} align={'middle'}>
					...
					<Col xl={12} md={12} sm={24} xs={24}>
						...
						>
							<FormInput placeHolder="Please enter email" type="email" maxLength={50} />
						</Form.Item>
					</Col>
				</Row>
